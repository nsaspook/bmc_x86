...
${OBJECTDIR}/_ext/5c0/bmc.o: ../bmc.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g `pkg-config --cflags comedilib` `pkg-config --cflags xaw7`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/bmc.o ../bmc.c

${OBJECTDIR}/_ext/511e00a9/daq.o: ../bmc/daq.c
	${MKDIR} -p ${OBJECTDIR}/_ext/511e00a9
	${RM} "$@.d"
	$(COMPILE.c) -g `pkg-config --cflags comedilib` `pkg-config --cflags xaw7`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/511e00a9/daq.o ../bmc/daq.c
